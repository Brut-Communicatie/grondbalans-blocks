 ...
 */
registerBlockType( 'cgb/grondbalans-contact-persoon', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'Grondbalans - Contactpersoon' ), // Block title.
	...
	edit: ( props ) => {
		...
		return (
			<div className="editor__persoon">
				...
				<input type="text" onBlur={updateFunction} onChange={updateFunction} value={props.attributes.functie} placeholder="Functie"/>
